...
# frontmatter 없는 특수 파일: 기존 인덱스 줄을 그대로 유지(이 외 description 부재 = error)
...
def parse_index(text):
    """현 MEMORY.md → (ordered entries [(fname, hook)], footer lines, sentinel line)."""
    entries, footer = [], []
...
def main():
    ...
    candidate, rep = build(args.allow_truncate)
