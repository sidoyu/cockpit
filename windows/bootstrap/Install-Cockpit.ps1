...
$PinnedImageUrl = 'https://github.com/sidoyu/cockpit/releases/download/v0.1.12/cockpit-wsl.tar.gz'
$PinnedSha256   = '34114e39fcf502514725dab2b6f662850e47246d440a38bc26a2aeac43c77ad4'   # cockpit-wsl.tar.gz SHA-256 (golden-build 산출).
$MarketplaceUrl = 'https://github.com/sidoyu/cockpit'                                  # /plugin marketplace add 실주소(게시자 sidoyu·cc-companion).
$PinnedDashboardCmdUrl    = 'https://github.com/sidoyu/cockpit/releases/download/v0.1.12/Cockpit-Dashboard.cmd'
